...
```{r fractional change, fig.height = 12/1.66, fig.width = 12, warning=FALSE}
...
```{r Proportion of richness across latitudes, fig.height = 12/1.66, fig.width = 12, warning=FALSE}
...
```{r, fig.height = 20/1.66, fig.width = 20}
...
```{r, fig.height = 12/1.66, fig.width = 12}
...
## Visualisation
```{r Detectability per lifestyle per plot, fig.height = 12/1.66, fig.width = 13}
